...
declare const __LONS_APP_URL__: string
declare const __LONS_API_URL__: string
declare const __LONS_VERSION__: string
...
export const APP_URL = clean(__LONS_APP_URL__)
export const API_URL = clean(__LONS_API_URL__)
export const VERSION = __LONS_VERSION__
