...
export function copyFor(view: PanelView, snapshot: PanelSnapshot): ViewCopy {
  switch (view) {
    case "first-install":
      return {
        title: "Welcome to LIEND",
        body: "LIEND shows liquidity context for supported Solana token pages. Connect to get started.",
        primary: { label: "Connect LIEND", action: "START_PAIRING" },
        secondary: { label: "Open LIEND", action: "OPEN_APP" },
      }
    case "disconnected":
      return {
        title: "Connect this browser",
        body: "Approve this browser in the LIEND app to see liquidity context here.",
        primary: { label: "Connect LIEND", action: "START_PAIRING" },
        secondary: { label: "Open LIEND", action: "OPEN_APP" },
      }
    case "pairing":
      return {
        ...
        body: `Approve this browser in the LIEND app. Check the code matches: ${
    ...
    case "session-expired":
      return {
        ...
        body: "Your LIEND session expired or this browser was revoked.",
    ...
    case "not-configured":
      return {
        ...
        body: "This build has no LIEND app or API address. Rebuild with LIEND_APP_URL and LIEND_API_URL set.",
        primary: null,
        secondary: null,
      }
    case "error":
      return {
        ...
        body: snapshot.error ?? "LIEND data is unavailable right now.",
    ...
    case "unsupported-page":
      return {
        ...
        body: "Open a token page on pump.fun to see LIEND context.",
        primary: { label: "Open LIEND", action: "OPEN_APP" },
        secondary: null,
      }
    case "supported-no-token":
      return {
        title: "No token detected",
        body: "Open a specific token page to see its LIEND context.",
        primary: { label: "Open LIEND", action: "OPEN_APP" },
        secondary: null,
      }
    case "detecting":
    ...
    case "detection-failed":
      return {
        ...
        body: "LIEND could not identify the token on this page.",
        primary: { label: "Retry", action: "REFRESH" },
        secondary: { label: "Open LIEND", action: "OPEN_APP" },
      }
    case "token-loading":
    ...
    case "holder-check-pending":
      return {
        title: "Checking your LIEND balance",
        body: "Your LIEND holdings could not be verified yet. This does not mean you are ineligible.",
        primary: { label: "Retry", action: "REFRESH" },
        secondary: { label: "Open in LIEND", action: "OPEN_IN_LIEND" },
      }
    case "not-eligible":
      return {
