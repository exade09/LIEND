...
export function BorrowPanel({ market }: BorrowPanelProps) {
  const [collateralAmount, setCollateralAmount] = useState(market.ticker === "LIEND" ? 100000 : 25000)
  ...
  const route = useMemo(
    () => ["Position check", "Market verify", "Collateral", "LIEND program", "SOL settlement"],
    [],
  )
